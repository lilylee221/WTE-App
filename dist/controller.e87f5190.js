...
exports.TIMEOUT_SEC = exports.RES_IN_PAGE = exports.API_URL = void 0;
const API_URL = 'https://www.themealdb.com/api/json/v1/1/';
exports.API_URL = API_URL;
const TIMEOUT_SEC = 5;
exports.TIMEOUT_SEC = TIMEOUT_SEC;
const RES_IN_PAGE = 8;
exports.RES_IN_PAGE = RES_IN_PAGE;
...
exports.state = exports.removeBookmark = exports.loadSearchResults = exports.loadRecipe = exports.getSearchResultsPage = exports.callBookmarks = exports.addBookmark = void 0;
...
const state = {
  ...
  search: {
    keyword: '',
    results: [],
    resultsInPage: _config.RES_IN_PAGE,
    page: 1
  },
  bookmarks: []
};
...
const loadRecipe = async function (id) {
  try {
    const data = await (0, _helpers.getJSON)("".concat(_config.API_URL, "lookup.php?i=").concat(id));
    state.recipe = data.meals[0];

    if (state.bookmarks.find(bookmark => bookmark.idMeal === state.recipe.idMeal)) {
...
const loadSearchResults = async function (keyword) {
  try {
    ...
    const data = await (0, _helpers.getJSON)("".concat(_config.API_URL, "search.php?s=").concat(keyword));
...
const addBookmark = function (recipe) {
  //add bookmark
  state.bookmarks.push(recipe); //store it

  storeBookmarks(); //mark current recipe bookmarked
...
const removeBookmark = function (recipe) {
  //delete bookmark
  const index = state.bookmarks.findIndex(bookmark => bookmark.idMeal === recipe.idMeal);
  state.bookmarks.splice(index, 1); //update localStorage

  storeBookmarks(); //remove bookmark from current recipe
...
const callBookmarks = function () {
  const storage = localStorage.getItem('bookmarks');
  if (storage) state.bookmarks = JSON.parse(storage);
};

exports.callBookmarks = callBookmarks;
},{"./helpers.js":"src/js/helpers.js","./config.js":"src/js/config.js"}],"src/js/views/view.js":[function(require,module,exports) {
"use strict";
...
class View {
  ...
  update(data) {
    ...
    const newDom = document.createRange().createContextualFragment(newRecipeInnerHtml);
  ...
  renderError() {
    ...
    const markup = "\n      <span class=\"error-message\"><i class=\"fas fa-exclamation-triangle\"></i>".concat(message, "</span>");
...
class RecipeView extends _view.default {
  constructor() {
    ...
    _defineProperty(this, "_errorMessage", 'We cannot find such recipe. Please try another one.');
  }
  ...
  _generateMarkup() {
    const ingredientsArr = Object.keys(this._data).filter(key => key.includes('Ingredient') && this._data[key] !== '' && this._data[key] !== null).map(k => this._data[k]);
    const measureArr = Object.keys(this._data).filter(key => key.includes('Measure') && this._data[key] !== '' && this._data[key] !== null).map(k => this._data[k]);
    let ingredientAndMeasure = [];
    ingredientsArr.forEach((ing, i) => {
      const measurement = measureArr[i];
      ingredientAndMeasure.push("<li class=\"recipe__ingredients__item\"><i class=\"fas fa-check\"></i> ".concat(measurement, " ").concat(ing, "</li>"));
    });
    return " \n    <img src=\"".concat(this._data.strMealThumb, "\" alt=\"recipe thumbnail image\" class=\"recipe__img\" />\n   \n    <div class=\"recipe__info\">\n        <div class=\"recipe__info__title-and-type\">\n            <h1 class=\"recipe__info__title\">").concat(this._data.strMeal, "</h1>\n             <span class=\"recipe__info__type\">").concat(this._data.strArea, "/").concat(this._data.strCategory, "</span>\n        </div>\n        <button class=\"recipe__info__bookmark\"><i class=\"fa").concat(this._data.bookmarked ? 's' : 'r', " fa-bookmark\"></i></button>  \n      </div>\n\n  <div class=\"recipe__ingredients\">\n    <h2>Recipe Ingredients</h2>\n    <ul class=\"recipe__ingredients__list\">\n    ").concat(ingredientAndMeasure.join(''), "\n    </ul>\n    </div>\n    <div class=\"recipe__instructions\">\n    <h2>Instructions</h2>\n    <p>\n        ").concat(this._data.strInstructions, "\n    </p>\n    <a href=\"").concat(this._data.strYoutube, "\" class=\"recipe__instructions__video\" target=\"_black\"><i class=\"far fa-play-circle\"></i> Watch How To Cook</a>\n  </div>");
  }
...
var _inputEl = /*#__PURE__*/new WeakMap();

class SearchView {
  constructor() {
    _classPrivateFieldInitSpec(this, _parentEl, {
      writable: true,
      value: document.querySelector('.header__search')
    });

    _classPrivateFieldInitSpec(this, _inputEl, {
      writable: true,
      value: document.querySelector('.header__search__input')
    });
  }

  getKeyword() {
    return _classPrivateFieldGet(this, _inputEl).value;
  }
...
class ResultsView extends _view.default {
  constructor() {
    ...
    _defineProperty(this, "_parentEl", document.querySelector('.recipe-list'));

    _defineProperty(this, "_errorMessage", 'No recipe found for the keyword.');
  }
  ...
  _generateList(result) {
    return "<li class=\"recipe-list__item\">\n<a href=\"#".concat(result.idMeal, "\" class=\"recipe-list__item__link\">\n  <img src=\"").concat(result.strMealThumb, "\" alt=\"recipe image\" class=\"recipe-list__item__img\" />\n  <span class=\"recipe-list__item__title\">").concat(result.strMeal, "</span>\n</a>\n</li>");
  }
...
exports.default = _default;
},{"./view.js":"src/js/views/view.js"}],"src/js/views/bookmarksView.js":[function(require,module,exports) {
"use strict";
...
class BookmarksView extends _view.default {
  constructor() {
    ...
    _defineProperty(this, "_parentEl", document.querySelector('.header__bookmarks__list'));

    _defineProperty(this, "_errorMessage", 'There is not any bookmark yet.');
  }
...
class PaginationView extends _view.default {
  constructor() {
    ...
    _defineProperty(this, "_parentEl", document.querySelector('.list__pagination'));
  }
  ...
  _generateMarkup() {
    ...
    if (currentPage === 1 && pageNumber > 1) {
      return "<button class=\"list__pagination__btn--next\" data-goto=\"".concat(currentPage + 1, "\">\n      Page ").concat(currentPage + 1, " <i class=\"fas fa-arrow-right\"></i>\n    </button>");
    ...
    if (currentPage < pageNumber) {
      //other page
      return "\n      <button class=\"list__pagination__btn--prev\" data-goto=\"".concat(currentPage - 1, "\">\n      <i class=\"fas fa-arrow-left\"></i> Page ").concat(currentPage - 1, "\n    </button>\n      <button class=\"list__pagination__btn--next\" data-goto=\"").concat(currentPage + 1, "\">\n      Page ").concat(currentPage + 1, " <i class=\"fas fa-arrow-right\"></i>\n    </button>");
    }

    if (currentPage === pageNumber) {
      // last page
      return "<button class=\"list__pagination__btn--prev\" data-goto=\"".concat(currentPage - 1, "\">\n      <i class=\"fas fa-arrow-left\"></i> Page ").concat(currentPage - 1, "\n    </button>");
    }
  }
...
const listEl = document.querySelector('.recipe-list'); //spinner function
...
const controlRecipes = async function () {
  try {
    ...
    _recipeView.default.renderSpinner(); //update result view to mark selected result


    _resultsView.default.update(model.getSearchResultsPage()); //load Recipe API
...
const controlSearchResult = async function () {
  try {
    //Get search keyword
    const keyword = _searchView.default.getKeyword();

    if (!keyword) return; //Render spinner

    _resultsView.default.renderSpinner(); //load search results


    await model.loadSearchResults(keyword); //Render results
...
const controlBookmark = function () {
  //add/remove bookmark
  if (!model.state.recipe.bookmarked) model.addBookmark(model.state.recipe);else model.removeBookmark(model.state.recipe); //update recipe view

  _recipeView.default.update(model.state.recipe); //render bookmark list
...
const init = () => {
  ...
  _bookmarksView.default.addHandlerRender(loadBookmarks);
  ...
  _paginationView.default.addHandlerClick(controlPaginationBtn);
};

init();
},{"./model.js":"src/js/model.js","./views/recipeView.js":"src/js/views/recipeView.js","./views/searchView.js":"src/js/views/searchView.js","./views/resultsView.js":"src/js/views/resultsView.js","./views/bookmarksView.js":"src/js/views/bookmarksView.js","./views/paginationView.js":"src/js/views/paginationView.js","core-js/stable":"node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
